...
export function OnlinePlayersCount() {
  ...
  return (
    <div className="absolute top-6 right-6 z-50 flex items-center gap-2 bg-gothic-black/80 backdrop-blur-sm border border-gothic-darkRed rounded-lg px-4 py-2 shadow-lg">
