  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-8">
      ...
      >
        ...
        {/* Display message from Player 1 if exists */}
        {affirmations.player1_to_player2 && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* Form to send message to Player 1 */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Card className="candle-glow">
            <CardHeader>
              <CardTitle className="text-center text-xl">
                {affirmations.player1_to_player2
                  ? "Send Your Glaze to Goddess"
                  : "Send a Glaze to Goddess"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Textarea
                    placeholder="Write your glaze here..."
                    value={myMessage}
                ...
                >
                  {isSubmitting ? "Sending..." : "Send Glaze"}
                </Button>
              </form>
            </CardContent>
          </Card>
